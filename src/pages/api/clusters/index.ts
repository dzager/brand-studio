...
function buildClusterSystemPrompt(brand: ReturnType<typeof buildBrandEngine>): string {
    ...
    const parts: string[] = [
        ...
        `1. **Pillar Page** — comprehensive hub article targeting the broadest keyword (2,500–5,000+ words)`,
        `2. **Supporting Pages** (5–8) — deep-dive articles on major subtopics, each targeting a mid-volume keyword (1,200–2,500 words)`,
        `3. **Long-Tail / FAQ Pages** (8–15) — focused articles targeting specific, low-competition queries (600–1,200 words)`,
        ``,
        `### Additional Page Types (assign as supporting or long-tail based on depth)`,
        `- **Definition / Glossary** — capture featured snippets and AI citations (400–800 words). Assign as long-tail.`,
        `- **Comparison Article** — high-intent commercial traffic (1,500–3,000 words). Assign as supporting.`,
        `- **How-To Guide** — procedural search intent (1,500–3,500 words). Assign as supporting.`,
        ``,
...
function buildClusterUserPrompt(topic: string): string {
    ...
    return [
        ...
        ``,
        `Generate:`,
        `1. One pillar page (comprehensive, 2,500-5,000+ words)`,
        `2. 5-8 supporting pages (mid-depth, 1,200-2,500 words each; comparison articles: 1,500-3,000; how-to guides: 1,500-3,500)`,
        `3. 8-15 long-tail/FAQ pages (focused, 600-1,200 words each; definition/glossary entries: 400-800)`,
        ``,
