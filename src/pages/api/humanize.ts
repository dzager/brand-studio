...
export default async function handler(
    ...
    try {
        ...
        if (title && typeof title === "string") {
            ...
            const humanizedTitleResult = await getTextResponse("gpt-5.4", "", titlePrompt, { temperature: 0.5 });
        ...
        if (excerpt && typeof excerpt === "string") {
            ...
            const humanizedExcerptResult = await getTextResponse("gpt-5.4", "", excerptPrompt, { temperature: 0.5 });
