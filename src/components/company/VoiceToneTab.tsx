                ...
                <div className="space-y-4 pt-3">
                    ...
                    {!form.voice_profile ? (
                        ...
                        <>
                            ...
                            <Field label="Headline Style" value={form.voice_profile.headline_style} editing onChange={v => setForm(prev => ({ ...prev, voice_profile: prev.voice_profile ? { ...prev.voice_profile, headline_style: v } : prev.voice_profile }))} rows={3} />
                            <Field label="Article Blueprint" value={form.voice_profile.article_blueprint} editing onChange={v => setForm(prev => ({ ...prev, voice_profile: prev.voice_profile ? { ...prev.voice_profile, article_blueprint: v } : prev.voice_profile }))} rows={4} />
                            <Field label="Target Length" value={form.voice_profile.target_length} editing onChange={v => setForm(prev => ({ ...prev, voice_profile: prev.voice_profile ? { ...prev.voice_profile, target_length: v } : prev.voice_profile }))} rows={2} />
